...
class GroupStyle {
  ...
  const factory GroupStyle.table() = FlexGroupStyle;
  const factory GroupStyle.wrap() = FlexGroupStyle;
...
class TableGroupStyle extends GroupStyle {
  ...
  TableGroupStyle copyWith({
    ...
    return TableGroupStyle(
      textDirection: textDirection ?? this.textDirection,
      mainVerticalDirection: mainVerticalDirection ?? this.mainVerticalDirection,
      crossVerticalDirection: crossVerticalDirection ?? this.crossVerticalDirection,
